        ...
        <div className="table-wrap admin-products-table-wrap">
          <table className="data-table admin-products-table">
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan="15" style={{ textAlign: 'center', padding: '50px' }}>
                    <div style={{ display: 'inline-block', width: '40px', height: '40px', border: '4px solid rgba(255, 255, 255, 0.1)', borderTop: '4px solid #00e5ff', borderRadius: '50%', animation: 'spin 1s linear infinite' }}></div>
                  </td>
                </tr>
              ) : joiningPackageRows.length === 0 ? (
                <tr>
                  <td colSpan="15" style={{ textAlign: 'center', padding: '50px', color: '#a0aec0' }}>No Joining Packages found.</td>
                </tr>
              ) : (
