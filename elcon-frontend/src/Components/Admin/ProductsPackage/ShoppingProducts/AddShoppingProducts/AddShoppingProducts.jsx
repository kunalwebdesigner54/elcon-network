...
function AddShoppingProducts() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      window.alert(error?.response?.data?.message || 'Unable to add shopping product');
    }
  };
          ...
          <div className="admin-add-product-left">
            <div className="admin-add-product-table" role="group" aria-label="basic-product-details">
              ...
              <label className="admin-add-product-row">
                ...
                <input name="productName" type="text" defaultValue="Foce Watch" />
              </label>
              <label className="admin-add-product-row">
                <span>Product Code</span>
                <input name="productCode" type="text" defaultValue="PDT-201" />
              </label>
              <label className="admin-add-product-row">
                <span>HSN Code</span>
                <input name="hsnCode" type="text" defaultValue="8517" />
              </label>
              <label className="admin-add-product-row">
                <span>Stock</span>
          ...
          <div className="admin-add-product-right">
            <div className="admin-add-product-table" role="group" aria-label="pricing-product-details">
              <label className="admin-add-product-row">
                ...
                <input name="mrpPrice" type="text" defaultValue="950" />
              </label>
              <label className="admin-add-product-row">
                <span>DP Price</span>
              ...
              <label className="admin-add-product-row">
                ...
                <input name="levelPoint" type="number" defaultValue="100" />
              </label>
              <label className="admin-add-product-row">
                <span>B.V Point</span>
              ...
              <label className="admin-add-product-row">
                <span>Size</span>
                <input name="size" type="text" defaultValue="Standard" />
              </label>
              <label className="admin-add-product-row">
                <span>Color</span>
                <input name="color" type="text" defaultValue="Black" />
              </label>
              <label className="admin-add-product-row">
                <span>Weight</span>
