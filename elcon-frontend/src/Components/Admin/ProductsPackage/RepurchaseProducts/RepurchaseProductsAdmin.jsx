                ...
                <tr key={row.id || row.productCode}>
                  ...
                  <td>
                    <div className="kyc-action-group" style={{ display: "flex", gap: "8px", justifyContent: "center" }}>
                      <button className="kyc-action-btn kyc-action-cyan" aria-label="View" title="View" onClick={() => navigate('/products-package/repurchase-products/add-new', { state: { product: row, mode: 'view' } })}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                      </button>
                      <button className="kyc-action-btn kyc-action-green" aria-label="Edit" title="Edit" onClick={() => navigate('/products-package/repurchase-products/add-new', { state: { product: row, mode: 'edit' } })}>
